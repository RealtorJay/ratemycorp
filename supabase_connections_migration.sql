...
update companies set ceo_name = 'Laurent Freixe',      ceo_title = 'CEO',       headquarters = 'Vevey, Switzerland' where slug = 'nestle';
...
update companies set ceo_name = 'Elliott Hill',         ceo_title = 'CEO',       headquarters = 'Beaverton, OR',     lobbying_spend = '$2.1M (2023)'  where slug = 'nike';
...
update companies set ceo_name = 'David Joyner',         ceo_title = 'CEO',       headquarters = 'Woonsocket, RI',    lobbying_spend = '$8.7M (2023)'  where slug = 'cvs-health';
update companies set ceo_name = 'Stephen Hemsley',     ceo_title = 'CEO',       headquarters = 'Minnetonka, MN',    lobbying_spend = '$8.4M (2023)'  where slug = 'unitedhealth';
...
update companies set ceo_name = 'Brian Niccol',         ceo_title = 'CEO',       headquarters = 'Seattle, WA',       lobbying_spend = '$3.1M (2023)'  where slug = 'starbucks';
...
update companies set ceo_name = 'Bill Brown',           ceo_title = 'CEO',       headquarters = 'St. Paul, MN',      lobbying_spend = '$4.9M (2023)'  where slug = '3m';
